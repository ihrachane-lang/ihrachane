...
export const menuItems = [
  ...
  { name: "BLOG & CONTENT SEO", icon: icons.blog, isHeader: true },
  {
    ...
    hasSubmenu: true,
    subItems: [
      { name: "All Blog Posts", icon: icons.contents, path: "/dashboard/blog" },
      { name: "Create New Post", icon: icons.contents, path: "/dashboard/blog/create" },
    ],
  },
