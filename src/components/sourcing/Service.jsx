      ...
      <div className="site-container relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          <div className="lg:col-span-5 relative group">
            ...
            <div className="site-panel relative h-80 w-full overflow-hidden rounded-[2rem] bg-[#071D49] sm:h-96 lg:h-[460px]">
              {contentSideImg ? (
                <Image
                  src={contentSideImg}
                ...
                <div className="w-full h-full flex items-center justify-center bg-[#0B2A5B] text-white/70 font-bold">
                  IHRACHANE Sourcing
                </div>
              )}
              <div className="absolute inset-0 bg-gradient-to-t from-[#071D49]/90 via-transparent to-transparent pointer-events-none" />
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            {subCategories?.map((subCategory) => (
              ...
              >
                <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#F56600] to-[#FF7A00] text-xl text-white shadow-md shadow-orange-500/20 transition-transform group-hover:scale-110">
                  <FaBoxOpen />
                </div>

                <div className="flex-1 min-w-0 space-y-1.5">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg uppercase sm:text-xl font-bold text-[#071D49] group-hover:text-[#F56600] transition-colors">
                      {subCategory?.title}
                    </h3>
                    <FaArrowRight className="text-[#64748B] group-hover:text-[#F56600] group-hover:translate-x-1.5 transition-all text-sm flex-shrink-0 ml-2" />
                  </div>
